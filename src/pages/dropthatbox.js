...
export default function Home({deviceInfo, testMessage}) {
  ...
  useEffect(() => {
    if(testMessage == "ios"){
      window.location.assign("https://apps.apple.com/sk/app/drop-that-box/id1609472916") 
    } else {
      window.location.assign("https://play.google.com/store/apps/details?id=com.coldendev.dropthatbox")
    }
