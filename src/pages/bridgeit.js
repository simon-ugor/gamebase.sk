...
export default function Home({deviceInfo, testMessage}) {
  ...
  useEffect(() => {
    if(testMessage == "ios"){
      window.location.assign("https://apps.apple.com/app/bridge-it/id6593663594")
    } else {
      window.location.assign("https://play.google.com/store/apps/details?id=com.GameBase.BridgeIt")
    }
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Bridge It!" />
