...
export default function Home({deviceInfo, testMessage}) {
  ...
  useEffect(() => {
    if(testMessage == "ios"){
      window.location.assign("https://apps.apple.com/app/musical-space-helix/id6504370417")
    } else {
      window.location.assign("https://play.google.com/store/apps/details?id=com.GameBase.MusicalSpaceHelix")
    }
  ...
  return (
    <div>
      <Head>
        <title>Musical Space Helix</title>
        <meta name="description" content="Musical Space Helix" />
